...
public class Quake {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject a  = new JSONObject(SAMPLE_JSON_RESPONSE);
            ...
            for(i=0;i<b.length();i++)
            {
                ...
                int j = place.indexOf("of");
                String primary,sec;
                if(j!=-1)
                {
                    primary = place.substring(0,j+2);
                    sec = place.substring(j+2,place.length()-1);
                }
                else
                {
                    primary = "Near The";
                ...
                earthquakes.add(new Earthquake(mag,primary,sec,time,url));
            }
